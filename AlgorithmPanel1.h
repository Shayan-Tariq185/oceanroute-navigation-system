...
private:
    ...
    // Setup an input field with its components
...
public:
    ...
    void initialize(float windowWidth, float windowHeight, sf::Font& font)
    {
        ...
        txtDijkstraCost.setString("Dijkstra $");
        ...
        txtDijkstraTime.setString("Dijkstra T");
...
public:
    ...
    SubgraphPanel() : isVisible(false), inputFocused(false), animPhase(0.f),
    ...
    void initialize(float windowWidth, float windowHeight, sf::Font& font)
    {
        ...
        descriptionText.setString("Generate a subgraph showing only routes\noperated by a specific shipping company.");
        ...
        companyLabel.setString("COMPANY NAME");
        ...
        btnGenerateText.setString("GENERATE SUBGRAPH");
